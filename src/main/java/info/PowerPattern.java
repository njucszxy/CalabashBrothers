...
public class PowerPattern {
    public static int getRandomNum(int powerTop,int powerBottom)
    {
    ...
    //pattern 0
    public static int funcX(int r)
    {
        return r;
    }
    //pattern 1
    public static int funcX2(int r)
    {
        return r*r;
    }
    //pattern 2
    public static int funcRootX(int r)
    {
        return (int)(Math.log(r * (r-1)));
    }
    //pattern 3
    public static int funcSquareRootX(int r)
    {
        return (int)(Math.sqrt(r));
    }
    //pattern 4
    public static int funcEX(int r)
    {
